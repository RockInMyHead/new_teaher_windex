...
- Примеры: "двадцать пять" вместо "25", "две тысячи двадцать четвертый год" вместо "2024"
- "плюс пять" вместо "5", "умножить на три" вместо "×3"
- "сорок процентов" вместо "40%", "три целых две десятых" вместо "3,2"
- Это нужно для естественного звучания в TTS`;
    };
